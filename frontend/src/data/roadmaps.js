...
export const ROADMAPS = [
  ...
  },
  {
    ...
    icon: "layers",
    blocks: [
      { label: "Início", rows: [["sintaxe-java"]] },
      { label: "Estruturas de Dados", rows: [["arrays", "vetores", "matrizes"], ["tabelas-hash"]] },
      { label: "Paradigma", rows: [["poo"]] },
      { label: "Framework", rows: [["springboot"]] },
    ],
  },
  {
    id: "web",
